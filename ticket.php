...
$stmt = $conn->prepare("
    SELECT t.*, r.*, m.title, m.image_poster, ms.show_date, ms.show_hour, 
           b.branch_name, p.payment_type, p.amount_paid, p.reference_number
    FROM TICKET t
...
<body>
    <div class="ticket-container">
        <div class="success-message">
            ✅ Payment Successful! Your ticket is now pending.
        </div>
        ...
        <div class="ticket-content">
            <div class="ticket-details">
                ...
                <div class="detail-item">
                    ...
                    <span class="detail-value"><?= htmlspecialchars($ticket['branch_name'] ?: 'SM Mall of Asia') ?></span>
                </div>
                <div class="detail-item">
                ...
                <div class="detail-item">
                    ...
                    <span class="detail-value <?= 'status-badge status-' . strtolower($ticket['payment_status'] ?? 'pending') ?>">
                        <?= ucfirst(str_replace('-', ' ', $ticket['payment_status'] ?? 'pending')) ?>
                    </span>
                </div>
